...
setting = {
    ...
    "menu": {
        ...
        "list": [
            ...
            {"uri": "manual", "name": "매뉴얼", "list": MANUAL_FILES},
            {"uri": "log", "name": "로그"},
        ],
    },
    "setting_menu": None,
...
P.logger.info("[ebs] manual menu bootstrap: %s", P.menu.get("sub2", {}).get("manual"))
